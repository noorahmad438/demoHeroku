...
var init = function () {
    rs = new RedisSessions({host:config.cfg.redis.server,port:config.cfg.redis.port,namespace:config.cfg.redis.namespace,appname:config.cfg.redis.appname});
}
...
exports.set = function (token,value) {
    return new Promise(function(resolve, reject){
        ...
        function(err, resp) {
            ...
            if(resp){
                console.log(resp,'iiiiiggfddddddddlllllllllllllllllll');
                resolve(resp);
            }
            /*
...
exports.getByToken = function (token) {
    console.log(token,"okkkkkkkkkkkkkkkkk");
    return new Promise(function(resolve, reject){
     console.log(resolve);
        rs.get({
            app: rsapp,
        ...
        function(err, resp) {
            if(err){
                //console.log(err,'llaaaaaaafhhhhhhhhhhhhhhhhhgjd');
                 reject(err);
            }
            if(resp){
                console.log(resp,'iiiiiggfddddddddlllllllllllllllllll');
